...
project = 'i-doit API Client for Python'
copyright = "2023, Tedd Schreiner"
...
version = idoit_api_client.__version__
# The full version, including alpha/beta/rc tags.
release = idoit_api_client.__version__
